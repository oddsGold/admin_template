...
const FileDropzone: React.FC<FileDropzoneProps> = ({ accept, handleSubmit, required = false }) => {
  ...
  // Генеруємо опис допустимих форматів
  ...
  return (
    <ComponentCard title="Dropzone">
      <div
        className={`transition border border-dashed cursor-pointer rounded-xl ${
          required ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
        }`}
      >
        <div
          {...getRootProps()}
